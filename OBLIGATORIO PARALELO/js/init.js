...
function verificarNoExisteUser(nUser) {
    let validacion = true;
    listaUsuarios.forEach(element => {  // para cada entrada de lista usuarios verifica si existe un nombre usuario igual que queremos registrar si lo encuentra no permite validar. 
...
function cotizar() {
    ...
    if (verificarEsNum(nuevoValor)) {
        ...
        alert("El valor del dólar fue actualizado correctamente.");
    } else { alert("El valor ingresado no es válido."); }
