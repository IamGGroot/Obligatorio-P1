...
let listaPrecargaInmuebles =
    ...
    { id: "inmueble", estado: "on", titulo: "Gerardo Silva", descripcion: "2", ciudad: "", precioPorNoche: 350, promedioCalif: 350, usuarioAnfitrion: "Camiiii_ok", fotos: [6, 7, 8] },
    { id: "inmueble", estado: "on", titulo: "casa grande", descripcion: "Gerardo Silva", ciudad: "", precioPorNoche: 450, promedioCalif: 250, usuarioAnfitrion: "Camiiii_ok", fotos: [9, 10, 11] },
    { id: "inmueble", estado: "on", titulo: "casa grande", descripcion: "4", ciudad: "Gerardo Silva", precioPorNoche: 550, promedioCalif: 100, usuarioAnfitrion: "Robert_63", fotos: [12, 13, 14] },
...
function selectCotizacion(usr) {
    ...
    if (usr === "Visitante" || usr === "Huesped") {
        divCotizacion.innerHTML = `<select id="selectCot"><option value="$">$</option><option value="U$D">U$D</option></select>`;
